...
## 2026-09-20 00:36（北京时间）：step60完整验证分化

- 两组均完成step60更新、470题完整验证及checkpoint保存，470/470均有reward，无run.exit，screen继续存活。A最新metrics为60并已保存60；B已继续至65并保存65。D1空闲约491GiB。
- A验证为62/470=13.1915%，相对同run的step40 68减少6题，相对恢复前step20随机重测74减少12题；B为78/470=16.5957%，相对step40 68增加10题，相对step20重测81少3题。不同随机评测仍不能直接当作确定因果，但A出现20→40→60的74→68→62连续下降，B的40步下降没有在60步延续。
