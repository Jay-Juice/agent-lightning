...
后续评分修复、28题受控复评分与470条真实轨迹重放已完成；最新状态以 `SWE_BASELINE_V2_GRADING_FIX_2026-09-18.md` 为准。

最新状态（2026-09-18 01:28复核）：B于00:53在初始验证后退出1，A未启动，在线更新0步。470题中69成功、373失败、28评分待复核；新增评分分类仅接受退出码0/1，误将需要归类的候选代码失败全部阻断。详见 `SWE_BASELINE_V2_P2_RESULT_2026-09-18.md`。下文启动状态为历史记录，不能据此认为任务仍运行。
