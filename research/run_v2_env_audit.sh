...
OUT=$RUNTIME/logs/swe-full-python-envs-reliable-v2-20260918-01
...
printf 'CPU/Docker environment audit started: %s\n' "$(date -Iseconds)"
...
printf 'CPU/Docker environment audit finished: %s\n' "$(date -Iseconds)"
