...
# Continue only A after the matching B completed successfully; keep all audit gates.
[[ "$(cat "$ROOT/training-capo-swe-v2-mini128-zero-4b-gpu47-$PAIR/run.exit")" == 0 ]]
for arm in A; do
