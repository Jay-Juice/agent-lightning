...
> 后续状态：本文 `-02` 启动快照之后，运行于 03:45 因补丁导出拒绝分支的属性未初始化而退出；287 份评分中45个成功，尚未训练。2026-09-13 晚间的修复与 `-03` 恢复进展见 [SWE_EXPORT_RECOVERY_2026-09-13.md](SWE_EXPORT_RECOVERY_2026-09-13.md)。
